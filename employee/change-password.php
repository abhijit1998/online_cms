...
if($num>0)
{
 $con=mysqli_query($con,"update employee set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
...
<head>
	...
	<title><?php echo ucfirst($_SESSION['alogin']) ?>| Change Password</title>
...
<ul class="widget widget-menu unstyled">
  ...
  $status="in Process";                 
$rt = mysqli_query($con,"SELECT tb.* FROM tblcomplaints tb JOIN category ct ON tb.status='$status' AND ct.categoryName='$cat' AND tb.category=ct.id");
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3><?php echo ucfirst($_SESSION['alogin']) ?> Change Password</h3>
							</div>
